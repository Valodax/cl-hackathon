...
// Array of winners
// Remove winner from participants array, and add it to the winners array.
...
contract StaticRaffle is VRFConsumerBaseV2, Ownable {
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords)
        ...
        override
    {
        // Catching random values from provided by Chainlink VRF as a callback
        // Decide the winners here
